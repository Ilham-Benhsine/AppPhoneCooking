...
export class BaseRecetteService {
  ...
  recettes = [
    ...
    new Recette('Salade César', '', 'https://assets.afcdn.com/recipe/20190704/94706_w600cxt0cyt0cxb4256cyb2832.jpg'),
    new Recette('Quiche au thon', '', 'https://assets.afcdn.com/recipe/20160404/43030_w600.jpg'),
    new Recette('Salade parisienne', 'La plus connue des salades avec des ingrédients de super qualité', 'https://fac.img.pmdstatic.net/fit/http.3A.2F.2Fprd2-bone-image.2Es3-website-eu-west-1.2Eamazonaws.2Ecom.2Ffac.2F2018.2F07.2F30.2F4c71e072-2ac4-48fd-b773-f26802a2e1d8.2Ejpeg/850x478/quality/90/crop-from/center/salade-parisienne-rapide-et-facile-de-laurent-mariotte.jpeg'),
    new Recette('Salade grecque à l’avocat', '', 'https://chefcuisto.com/files/2017/07/salade-grecque-avocat.jpg')
  ];
